...
<div class="sidebar">
    <ul>
        <li class="top"><a href="<?php echo fullURLfront; ?>/Customer/customer_service" class="<?php echo (empty($_SESSION['loggedin'])) ? 'disabled-link' : ''; ?>"><i class="fa fa-search"></i> Services</a></li>
